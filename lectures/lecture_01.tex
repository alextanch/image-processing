...
\begin{figure}
    ...
    \includegraphics[height=0.3\textheight]{coordinates.png}
    \hspace{1cm}
    \includegraphics[height=0.5\textheight]{gray_image.pdf}
\end{figure}
$$
...
\begin{figure}
    \centering
    \includegraphics[height=0.4\textheight]{RGB_image.png}
    \hspace{1cm}
    \includegraphics[height=0.5\textheight]{lena.png}
\end{figure}
$$
...
$$
\begin{itemize}
    \item RGB изображение -- трехканальное восьмибитное изображение
...
\end{figure}
\begin{itemize}
    \item цифровое изображение $\mathbf{F}$ -- трехмерный массив (тензор) размера $M\times N\times K$
    \item цифровое изображение задается набором $K$ матриц (каналов) $M\times N$
    $$
...
\begin{itemize}
    ...
    \item человек воспринимает длины волн $360\,\mbox{нм}=\lambda_1 < \lambda < \lambda_2=830\,\mbox{нм}$
...
\begin{figure}
    \centering
    \includegraphics[height=0.5\textheight]{color_experiment.jpg}
    \includegraphics[height=0.3\textheight]{color_mix.png}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[height=0.4\textheight]{XYZ.png}
\end{figure}
...
\begin{itemize}
    ...
    $$
        X = \int\limits_{[\lambda_1,\lambda_2]} {x}(\lambda)I(\lambda)\,d\lambda\,,\quad
        Y = \int\limits_{[\lambda_1,\lambda_2]} {y}(\lambda)I(\lambda)\,d\lambda\,,\quad
        Z = \int\limits_{[\lambda_1,\lambda_2]} {z}(\lambda)I(\lambda)\,d\lambda
    $$
\end{itemize}
\end{frame}
...
\begin{itemize}
    ...
    \item дуга на диаграмме соответствует монохроматическим цветам $\lambda_1 < \lambda  < \lambda_2$
...
\end{figure}
\begin{itemize}
    \item найти яркость изображения $\mathbf{Y}$ и вычислить среднюю яркость $\overline{\mathbf{Y}}$
    \item преобразовать цветовые плоскости \textbf{R}, \textbf{G} и \textbf{B} по формулам
    \begin{align*}
      \mathbf{R} &= \gamma \cdot \mathbf{R} + (1-\gamma)\cdot\overline{\mathbf{Y}}\\
      \mathbf{G} &= \gamma \cdot \mathbf{G} + (1-\gamma)\cdot\overline{\mathbf{Y}} \\
      \mathbf{B} &= \gamma \cdot \mathbf{B} + (1-\gamma)\cdot\overline{\mathbf{Y}}
  \end{align*}
  где $0 < \gamma < 1$
\end{itemize}
\end{frame}
...
\begin{itemize}
    \item случайным образом выбрать коэффициенты $\alpha$, $\beta$, $\gamma$, $\delta$ из диапазонов
    \begin{align*}
