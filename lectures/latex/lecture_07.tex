...
\vspace{0.5cm}
\begin{itemize}
    \item \textbf{SLAM (Simultaneous Localization and Mapping)} --- одновременное построение карты и локализация на ней.
    \vspace{0.2cm}
    
    \href{https://www.youtube.com/watch?v=GI90GYOCYuE}{{SLAM demo}}
    \vspace{0.2cm}

    \item \textbf{3D reconstruction} --- реконструкция трехмерной сцены по набору изображений.
    \vspace{0.2cm}

    \href{https://www.youtube.com/shorts/0yVtPQULpd8}{{3D reconstruction demo}}

    \item \textbf{Depth estimation} --- оценка глубины сцены по изображениям
    \vspace{0.2cm}

    \href{https://www.youtube.com/watch?v=172xfa95pQ8}{{Depth estimation demo}}
...
$$
    \mathbf{t} = \mathbf{o}_2 - \mathbf{o}_1
$$
